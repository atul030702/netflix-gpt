...
const VideoTitle = ({ title, overview }) => {
    ...
    return (
        <div className="text-white px-10 w-screen aspect-video absolute flex items-start justify-center flex-col space-y-4 bg-gradient-to-r from-black/50">
            <h1 className="text-2xl font-bold drop-shadow-md">{title}</h1>
            <p className="py-2.5 text-lg w-1/3 leading-relaxed drop-shadow-sm">{overview}</p>
            ...
            <div className="flex justify-start items-center gap-2.5">
                ...
                <button className="inline-flex justify-center items-center font-bold text-white bg-[#6D6D6EB3] rounded-sm gap-1.5 px-3 py-1 cursor-pointer bg-opacity-50 hover:bg-transparent/75">
